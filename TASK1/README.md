...
- To verirfy that apache2 is running as a service in our OS, use the following command below, if it is green and running then you did everything correctly
...
> sudo mysal_secure_installation
...
> sudo apache2ctl configtest if you see "syntax OK" then you good to go
