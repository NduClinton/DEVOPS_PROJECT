...
![alt text](<IMAGE/illustration 1.png>)
...
![alt text](<IMAGE/illustration 2.png>)
...
![alt text](<IMAGE/image 1 [task5].png>)
...
![alt text](<IMAGE/image 2 [task5].png>)

- On mysql-server Linux Server install MySQL Server software:
```bash
sudo apt update
```
![alt text](<IMAGE/image 3 [task5].png>)

- Then install the mysql-server package:
```bash
sudo apt install mysql-server
```
![alt text](<IMAGE/image 4 [task5].png>)
...
```
![alt text](<IMAGE/image 5 [task5].png>)

## SETTING IT UP

- Run: `sudo mysql`

- For the password I'll be using 'Fingerprint123', you can use any password of your choice then run paste the command below:
```bash
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'PassWord.1';
```
![alt text](<IMAGE/image 6 [task5].png>)

- Run a MySQL secure installation
```bash
sudo mysql_secure_installation
```
![alt text](<IMAGE/image 7 [task5].png>)
...
```
![alt text](<IMAGE/image 8 [task5].png>)
...
- After logging in to the MySQL console, confirm that you have access to the example_database database: `mysql> SHOW DATABASES;` This will give you the following output:
![alt text](<IMAGE/image 9 [task5].png>)
...
```
![alt text](<IMAGE/image 10 [task5].png>)

- You might need to configure MySQL server to allow connections from remote hosts.
```bash
sudo vim /etc/mysql/mysql.conf.d/mysqld.cnf
```
![alt text](<IMAGE/image 11 [task5].png>)
...
![alt text](<IMAGE/image 12 [task5].png>)
...
```
![alt text](<IMAGE/image 13 [task5].png>)

- install the mysql-client package:
```bash
sudo apt install mysql-client -y
```
![alt text](<IMAGE/image 14 [task5].png>)
...
![alt text](<IMAGE/image 15 [task5].png>)